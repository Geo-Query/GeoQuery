...
// import ExportWizard from "./ExportWizard"; // Make sure this import is correct
...
export interface ModalProps {
  ...
  jsonFilePath: string; // Add this to pass the JSON file path to ExportWizard
}
        ...
        <div className="relative mx-auto">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-thales-dark outline-none focus:outline-none min-w-[1200px] h-[800px] max-h-[800px]">
            <div className="flex items-start justify-between p-6 rounded-t">
              <h3 className="text-3xl text-white font-mono font-semibold">
                Export Wizard
              </h3>
              <button
...
{/* <button onClick={() => setShowExportWizard(true)}>Start Export Process</button> */}

{/* {showExportWizard && <ExportWizard jsonFilePath={props.jsonFilePath} onClose={() => setShowExportWizard(false)} isOpen={showExportWizard} />} */}
              <button
                onClick={props.onClose}
